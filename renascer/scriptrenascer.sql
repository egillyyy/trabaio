...
CREATE TABLE IF NOT EXISTS `renascer`.`tb_agendamento` (
  ...
  INDEX `fk_tb_agendamento_tb_pagamento1_idx` (`tb_pagamento_idpagamento` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_tb_agendamento_tb_taxa1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_agendamento_tb_pagamento1`
